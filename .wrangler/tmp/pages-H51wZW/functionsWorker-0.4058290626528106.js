...
async function onRequestPost(context) {
  ...
  try {
    const upstream = await fetch(webhookUrl, {
      ...
      body: JSON.stringify({
        secret,
        date: lead.timestamp || (/* @__PURE__ */ new Date()).toISOString(),
        name: lead.full_name || "",
        email: lead.email || "",
        phone: lead.phone || "",
    ...
    clearTimeout(timeoutId);
    const errorMessage = err && err.name === "AbortError" ? "Apps Script webhook timed out" : err instanceof Error ? err.message : "Unknown error calling Apps Script webhook";
...
// ../.wrangler/tmp/pages-H51wZW/functionsRoutes-0.058258798819373125.mjs
var routes = [
  {
