...
const CONTENT_OVERRIDES: Record<string, string> = {
  ...
  'from-missed-calls-to-booked-jobs-electricians': `
    ...
    <section class="space-y-6">
      ...
      <p class="text-slate-400 leading-8 text-lg">The result is that every single day, electrical contractors send paying customers to voicemail. And those customers do not leave messages — they call the next electrician on Google. The electrical contractors who win with AI are the ones who recognized this gap and closed it. Here are their stories.</p>
    </section>
        ...
        <table class="w-full text-sm text-slate-300 border-collapse">
          ...
          <tbody>
            <tr class="border-b border-slate-800">
              <td class="py-3 px-4">Brighton Electrical Services</td>
            ...
            <tr class="border-b border-slate-800">
              <td class="py-3 px-4">Metro Commercial Electric</td>
            ...
            <tr class="border-b border-slate-800">
              <td class="py-3 px-4">Windy City Emergency Electric</td>
            ...
            <tr class="border-b border-slate-800">
              <td class="py-3 px-4">Pacific Northwest Electric</td>
    ...
    <section class="space-y-6">
      ...
      <p class="text-slate-400 leading-8 text-lg">The electrical contractors in these case studies did not do anything special or complicated. They followed a straightforward process that any electrical contractor can replicate. Here is how to get similar results.</p>
