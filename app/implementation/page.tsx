...
const phases = [
    ...
    },
    {
        ...
        title: 'Testing',
        duration: 'Day 3',
        description: 'We run testing with real-world scenarios. Your team can make test calls, review transcripts, and provide feedback. We iterate on scripts and flows until they meet your standards.',
        deliverables: ['Internal team test calls', 'Script refinement based on feedback', 'Edge case handling verification', 'Quality assurance sign-off'],
    },
    {
        icon: Rocket,
        title: 'Launch',
        duration: 'Go-Live (Day 3)',
